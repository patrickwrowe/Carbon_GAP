...
## Introduction
This machine learning potential uses Gaussian process regression to learn the energies and forces acting on atoms directly from quantum mechanical calculations. The model enables atomistic modelling of carbon-based structures at an accuracy approaching that of direct quantum mechanical simulations, but at a computatuional cost that is orders of magnitude cheaper.
